...
| ---------------------------- | ---------------------------------------------------------- |
| **/api/ApiHealthCheck**      | Used by the caller to check whether the API is here.       |
| **/api/SeriesDocumentation** | The description of each series being exposed to Prometheus |
| **/api/Telemetry**           | The endpoint to post telemetry to.                         |
